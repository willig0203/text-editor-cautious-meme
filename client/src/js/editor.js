// Import methods to save and get data from the
// indexedDB database in './database.js'
...
export default class {
  constructor() {
    ...
    // When the editor is ready, set the value to
    // whatever is stored in indexeddb.
    // Fall back to localStorage if nothing is/
    ...
    // when the editor itself is loses focus
    // from local storage
    this.editor.on("blur", () => {
